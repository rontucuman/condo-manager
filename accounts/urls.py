...
urlpatterns = [
    ...
    path('activate-acct/', views.activate_acct, name='activate_acct'),
    path('process-active-change/', views.process_active_change, name='process_active_change'),

    path('testemailview/', views.testemailview, name='test_email_view'),
